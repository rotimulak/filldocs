  ...
  return (
    <section className="bg-gray-50" id="comparison">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h2 className="sr-only">Сравнение подходов</h2>
            ...
            <ul className="space-y-3">
              {oldWay.map((item) => (
                <li key={item} className="flex gap-3 text-sm text-gray-500">
                  <svg className="w-5 h-5 shrink-0 text-red-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <ul className="space-y-3">
              {newWay.map((item) => (
                <li key={item} className="flex gap-3 text-sm text-gray-700">
                  <svg className="w-5 h-5 shrink-0 text-green-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
